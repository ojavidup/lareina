...
import com.lareina.quality.service.MateriaPrimaService;
...
public class PruebaController {
	...
	@GetMapping("/recibos")
	public ResponseEntity<List<MateriaPrima>> getAllRecibos(){
		
		return new ResponseEntity<List<MateriaPrima>>(materiaPrimaService.GetRecibos(),HttpStatus.OK);
	}
